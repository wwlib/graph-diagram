...
const Diagram_1 = __webpack_require__(16);
exports.Diagram = Diagram_1.default;
const Markup_1 = __webpack_require__(23);
exports.Markup = Markup_1.default;
const Model_1 = __webpack_require__(9);
exports.Model = Model_1.default;
const ModelToCypher_1 = __webpack_require__(24);
exports.ModelToCypher = ModelToCypher_1.default;
const ModelToD3_1 = __webpack_require__(25);
...
const LayoutModel_1 = __webpack_require__(26);
...
const NodeSpeechBubble_1 = __webpack_require__(20);
const Radius_1 = __webpack_require__(21);
...
function compareSvg(expected, actual, report) {
        ...
        if (name != "xmlns") {
            ...
            if (actualAttribute == null) {
                ...
                if (expectedAttributeValue != actualAttributeValue) {
                    report(expected, actual, "Expected " + name + "=\"" + expectedAttributeValue + "\" but got " + name + "=\"" + actualAttributeValue);
                }
            }
        }
    }
    ...
    if (expectedChildElements.length === 0) {
        if (expected.textContent.trim() != actual.textContent.trim()) {
            report(expected, actual, "Expected text content \"" + expected.textContent + "\" but got \"" + actual.textContent + "\"");
        }
    }
    else {
...
var allPass = true;
var diagram = new index_1.Diagram(); //gd.diagram();
// console.log(diagram);
d3.selectAll(".example").each(function () {
    ...
    var models = index_1.Markup.parseAll(exampleRowSelection);
    ...
    var pass = true;
    compareSvg(exampleRow.select("td.expected-diagram svg").node(), exampleRow.select("td.actual-diagram svg").node(), function (expected, actual, message) {
        pass = false;
...
const LayoutRelationship_1 = __webpack_require__(18);
const LayoutNode_1 = __webpack_require__(6);
const HorizontalArrowOutline_1 = __webpack_require__(22);
const CurvedArrowOutline_1 = __webpack_require__(7);
class Layout {
...
Object.defineProperty(exports, "__esModule", { value: true });
const LayoutEntity_1 = __webpack_require__(4);
const RelationshipSpeechBubble_1 = __webpack_require__(19);
...
/***/ })
/******/ ]);
//# sourceMappingURL=example-browser-tests.js.map